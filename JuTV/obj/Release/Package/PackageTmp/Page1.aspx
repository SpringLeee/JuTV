<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Page1.aspx.cs" Inherits="JuTV.Page1" %>
...
<body>
                ...
                <div  class="carousel-inner" role="listbox">
                  ...
                  <% for (int i = 0; i < ListBanner.Count; i++){ %>
                    ...
                    <div class="item <%= i==0?" active":"" %>">
                      <a href="<%= ListBanner[i].link %>"><img src="<%= ListBanner[i].img %>" /></a>
                    </div>
    ...
    <div style="width:100%;margin:4px auto">
        ...
        <div class="data-item mydiv" data-info="<%= item.playurl %>">
            <div>
               <a href="PalyerPage.aspx?link=<%= item.playurl %>&roomid=<%= item.room_id %>"> <img src="<%= item.cover.src %>" /></a>
            </div>
            <div>
